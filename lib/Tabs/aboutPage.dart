        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
                ...
                style: TextStyle(
                    fontSize: 15.0, fontWeight: FontWeight.bold, color: Colors.black, height: 2)
            ),
            ListTile(

              title:Center(
                child: Text("Supervisor: Mr.Mohammed Salim "
                    "Developers:"
                    "(avin.kakamin@gmail.com ),(payam.mizori22@gmail.com )"
                    "",  style: TextStyle(
                  fontWeight: FontWeight.bold, fontSize: 11.0, color: Color(
                    0xffc11144), height: 2 ),),
